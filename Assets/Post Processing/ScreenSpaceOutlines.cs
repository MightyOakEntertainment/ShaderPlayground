...
public class ScreenSpaceOutlines : ScriptableRendererFeature {
    ...
    private class ScreenSpaceOutlineSettings {
        ...
        [Range(0.00001f, 0.1f)]
        public float noiseMultiply = 0.002f;
    ...
    private class ScreenSpaceOutlinePass : ScriptableRenderPass {
        ...
        public ScreenSpaceOutlinePass(RenderPassEvent renderPassEvent, ScreenSpaceOutlineSettings settings) {
            ...
            screenSpaceOutlineMaterial = new Material(Shader.Find("Hidden/ScreenSpaceOutlines"));
            ...
            screenSpaceOutlineMaterial.SetFloat("_NoiseScale", settings.noiseScale);
            screenSpaceOutlineMaterial.SetFloat("_NoiseMultiply", settings.noiseMultiply);
